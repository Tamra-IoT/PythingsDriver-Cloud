...
while True:
    smart_home.prepare_digitalWrite(D2,1)
    smart_home.prepare_digitalWrite(D5,1)
    smart_home.prepare_digitalWrite(D6,255)
    smart_home.prepare_digitalWrite(D7,1)
    smart_home.prepare_digitalWrite(D8,1)
    smart_home.prepare_digitalWrite(D9,1)
    smart_home.prepare_digitalWrite(D10,1)
    smart_home.prepare_digitalWrite(D11,1)
    ...
    smart_home.prepare_digitalWrite(D2,0)
    smart_home.prepare_digitalWrite(D5,0)
    smart_home.prepare_digitalWrite(D6,100)
    smart_home.prepare_digitalWrite(D7,0)
    smart_home.prepare_digitalWrite(D8,0)
    ...
    # smart_home.prepare_digitalWrite(D11,0)
    # smart_home.prepare_digitalWrite(A1,0)
    # smart_home.prepare_digitalWrite(A2,0)
    # smart_home.prepare_digitalWrite(D10,0)
    # smart_home.prepare_digitalWrite(D12,0)
    # smart_home.prepare_digitalWrite(D13,0)
    smart_home.sendCommandsFrame()
